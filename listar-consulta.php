	...
	if($qtd > 0){
		...
		while($row = $res->fetch_object()){
			...
			print "<td>
                        ...
                        <button class='btn btn-primary' onclick=\"location.href='?page=visualizar-prontuario&id_paciente=".$row->paciente_id_paciente."&id_consulta=".$row->id_consulta."';\">Prontuário</button>    
                    </td>";
			print "</tr>";
		}
		print "</table>";
